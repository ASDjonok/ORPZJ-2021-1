 ...
 */
public class ArmourOut extends Equipment {
    /**
     * Поле - колір
     */
    public String color;
     ...
     * @param color    колір
     */
    public ArmourOut(String name, String material, int cost, int weight, String color) {
     ...
     */
    public void action() {
        System.out.println("Protects from injuries");
    }
